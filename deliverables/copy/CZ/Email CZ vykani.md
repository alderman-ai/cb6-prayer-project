...
1. **Po třiceti letech trvalý domov v Praze 6** — 43 znaků. **DOPORUČENO.** Nese governing phrase doslovně, takže předmět, nadpis letáku i nadpis stránky si po otevření odpovídají. Konkrétní, bez patosu, bez naléhání.
2. **Třicet let nedělí v pronajatém hotelu** — 38 znaků. Vede nejsilnějším faktem z celého materiálu. Vyšší zvědavost, slabší message match.
3. **{{RECIPIENT_FIRST_NAME}}, novinky z našeho sboru v Dejvicích** — 55 znaků u krátkého jména. Použít jen tehdy, je-li slučovací pole spolehlivé v celém seznamu; jinak variantu 1. U institucí variantu 3 nepoužívat vůbec.

Žádné emoji, žádná verzálková slova, žádné vykřičníky.

## Preheader

*Máme povolení stavět. 14 milionů korun již upsali naši členové. Zde je, kde stojíme.*

---

## Tělo e-mailu

Vážená paní, vážený pane {{RECIPIENT_NAME}},
...
P.S. Na dar rádi vystavíme potvrzení pro daňové účely — stačí napsat na hospodar@cb6.cz. Vše ostatní najdete zde: [Pomozte postavit modlitebnu]({{LANDING_URL_CZ}})
...
- **Oslovení:** "Vážená paní, vážený pane {{RECIPIENT_NAME}}," je bezpečná gender-neutrální forma pro slučované pole. Pokud je u kontaktu známé pohlaví a titul, nahradit přesnou variantou ("Vážený pane faráři,", "Vážená paní ředitelko,"). Pro instituci bez konkrétní osoby použít "Vážení,".
