...
**Skim test:** nadpis + finanční blok + blok o darování musí dávat úplný smysl i při čtení samostatně.
**Názvy obrázků** jsou z `Resources/Brand/BRAND NOTES.md`, sekce 4; soubory jsou v `Resources/Modlitebna Images/`.

---

## Blok 1 — Hlavička

**Logo:** `logo-var1.png` (bílý wordmark — pouze na tmavém podkladu; vyvedený z inkoustové `#264653`). Před finální sazbou vyžádat vektor v tiskovém rozlišení; 514 px je nad ~40 mm málo.

**Eyebrow:** CB Dejvice · Církev bratrská · Praha 6
...
**Podnadpis:** Zdravý a rostoucí sbor staví modlitebnu pro své sousedy.

**Obrázek:** `02_proposed-design-overlay-on-photo.jpg` — navrhovaná modlitebna vsazená do fotografie budovy, jak stojí dnes. Přes celou šířku v horní třetině.

---

## Blok 3 — Příběh (~120 slov)

**Nadpis sekce:** Kde jsme dnes

Sbor CB Dejvice vznikl v roce 1995, krátce po pádu komunismu, aby přinesl naději evangelia do Prahy 6. Po třiceti letech nás je asi 150 členů — na české poměry hodně — ve čtvrti se 109 000 obyvateli a 38 000 vysokoškoláky, z nichž mnozí nikdy nebyli v evangelickém kostele.
...
## Blok 4 — Proč stavět (max 5 odrážek)
...
**Obrázek:** žádný. Blok nechat čistě typografický.

---

## Blok 7 — Harmonogram a důvěryhodnost
...
## Blok 8 — Darování a CTA

**Nadpis sekce:** Pomozte postavit modlitebnu

Zveme přátele, partnerské sbory, nadace i jednotlivé dárce, aby zvážili dar na zbývajících 40 000 000 Kč. Každý dar pomáhá vytvořit místo, kde se lidé v Praze 6 mohou setkat s Kristem a najít naději — pro tuto generaci i pro ty další.
...
**Popisek pod druhým QR kódem:** Naskenujte a přečtěte si celý projekt
...
- **QR na stránku** — odkazuje na `{{LANDING_URL_CZ}}`, ne na platbu. Umístit vedle věty s odkazem, s vytištěnou URL přímo pod ním pro toho, kdo čte na papíře nebo skenovat nechce.
- Oba minimálně 2 cm, každý s vlastním popiskem, mezi nimi zřetelná mezera nebo dělicí linka. Nikdy je neumisťovat vedle sebe bez popisků.

**Poznámka:** americký daňový disclaimer z anglické verze zde **není** a nemá se doplňovat. České znění nese pouze standardní větu o potvrzení o daru pro daňové účely.
...
**Obrázek:** `favicon.png` (samotná zlatá značka) jako drobný prvek v patičce, nebo inverzní logo, pokud je pás patičky v inkoustové `#264653`.

---

## Poznámky pro build

- **Paleta:** inkoustová `#264653`, hlavní akcent `#E9C46A`, světlý akcent `#FFD56E`, papírová bílá. Zlatou rezervovat pro CTA a linku pod čísly, jinde ne.
- **Písmo:** Raleway (SIL OFL — volné k vložení do PDF). Pro české znění je nutná **latin-ext** podmnožina — bez ní vypadnou ě, š, č, ř, ž, ů. Zkontrolovat v exportu.
- **Typografie:** tvrdé mezery v číslech (54 000 000 Kč) a za jednoznakovými předložkami (v, s, k, z). Datum ve tvaru "29. června 2024".
- **Záměrně chybí:** stupně uznání dárců, jmenná práva, žebříček doporučených částek a jakýkoli termín. Každá z těchto věcí je rozhodnutí klienta, ne copywritingu — upozornit, nepředjímat.
