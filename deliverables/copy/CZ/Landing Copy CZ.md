...
**Struktura:** 9 bloků podle `Research/Web Design Best Practices.md` §3.
**Globální pravidla:** žádná navigace v hlavičce (jen logo); žádné video nad blokem s darováním; žádná vyskakovací okna, exit overlaye, odpočty ani termínové widgety; jedna akcentní barva (`#E9C46A`) vyhrazená výhradně pro CTA; sticky CTA v hlavičce na všech šířkách; celkem tři tlačítka v textu stránky.

**Title (SEO):** Po třiceti letech trvalý domov v Praze 6 — CB Dejvice
**Meta description:** Sbor CB Dejvice staví modlitebnu v Evropské ulici v Praze 6. Projekt za 54 milionů korun, 14 milionů už upsali členové, 40 milionů ještě chybí.

**PŘED PUBLIKACÍ — ověřit u klienta:** název banky "Raiffeisenbank" (blok 7 a FAQ) je odvozen z kódu 5500 v účtu 1031051032/5500 a sbor ho nepotvrdil. Potvrdit, nebo název banky vypustit a psát "sborový účet na modlitebnu".
...
**Nadpis:**
# Po třiceti letech trvalý domov v Praze 6

**Podnadpis:**
Náš sbor se už přes třicet let schází k bohoslužbám v pronajatém hotelovém sále. Teď máme povolení postavit vlastní modlitebnu — a chybí nám 40 000 000 Kč.

**Hlavní tlačítko:** Pomozte postavit modlitebnu *(kotví na blok s platebními údaji)*

**Řádek pod tlačítkem, drobněji, ale ne jako drobné písmo:**
Dary přijímáme převodem na sborový účet nebo QR platbou. Na požádání vystavíme potvrzení o daru pro daňové účely.

**Obrázek:** `02_proposed-design-overlay-on-photo.jpg` — navrhovaná modlitebna vsazená do dnešní fotografie ulice. Desktop: dva sloupce, obrázek vlevo, nadpis a CTA vpravo. Mobil: obrázek se ořízne na pruh, CTA v dosahu jednoho scrollu.

**Alternativní nadpisy**
- **Varianta A (doporučeno):** *Po třiceti letech trvalý domov v Praze 6* — nese governing phrase doslovně z předmětu e-mailu i z nadpisu letáku. Message match je v celém řetězci nejsilnější proměnná.
- **Varianta B:** *Pomozte postavit modlitebnu v srdci Prahy 6* — přímočařejší směrem k dárci, ale rozbíjí doslovnou shodu s e-mailem.
- **Varianta C:** *Třicet let nedělí v pronajatém hotelu* — nejsilnější zvědavost, nejslabší srozumitelnost pro člověka, který přijde studený z QR kódu.
...
**Obrázek:** `05_foyer-toward-evropska-street.jpg` — foyer s výhledem do Evropské, s kavárnou a oknem dětského programu. Ukazuje všední týdenní život, který tahle budova už dnes nese.
...
**Tlačítko (druhé ze tří):** Pomozte postavit modlitebnu

---

## Blok 5 — Finanční přehled

**Nadpis sekce:** Kde stojíme

| | Kč | USD |
|---|---|---|
| **Náklady projektu** | 54 000 000 Kč | 2,55 mil. $ |
...
**Tlačítko (třetí ze tří):** Pomozte postavit modlitebnu
...
Sbor Církve bratrské, protestantské církve v České republice.

Dotazy k projektu: **modlitebna@cb6.cz**
Dary a potvrzení: **hospodar@cb6.cz**
Informace o projektu: [cb6.cz/modlitebna](https://www.cb6.cz/modlitebna)

*Na požádání vystavíme potvrzení o daru pro daňové účely.*
...
- **Rozsah textu:** zhruba 900 slov čtenářského textu v blocích 2–8, bez nadpisů a poznámek k obrázkům a zobrazení.
- **Pouze tři tlačítka v textu** — hero, za blokem o stavbě pod zemí, za platebními údaji — plus sticky tlačítko v hlavičce. Vždy stejné znění, všechna kotví na blok 7. Nepřidávat další; víc už působí jako tlak.
- **Neověřený název banky.** "Raiffeisenbank" (blok 7 a FAQ) je odvozen z kódu 5500. Před publikací potvrdit, nebo název banky vypustit.
- **Záměrně chybí:** stupně darů, doporučené částky, pojmenovaná úroveň "vedoucího daru", možnost pravidelného měsíčního daru a jakákoli mřížka "další způsoby darování". Vše doporučuje rešerše a vše je rozhodnutí klienta — upozornit, nepředjímat. Pokud klient doporučené částky doplní, patří do bloku 7 nad platební údaje.
- **Záměrně chybí také:** jakékoli tvrzení, že je účet na modlitebnu oddělený od provozního účtu sboru nebo že na něm 14 milionů od členů leží. Obojí by bylo silné pro důvěru a ani jedno není písemně podložené. Zeptat se; netvrdit.
- **Upsáno ≠ zaplaceno.** Nikde na stránce nesmí být 14 milionů od členů popsáno jako vybrané, přijaté, uložené nebo získané.
- **Daňová část:** anglická verze nese americký disclaimer (dar není odpočitatelný v USA, ani Gift Aid v UK). V české verzi je **odstraněn** a nahrazen standardní větou o potvrzení o daru pro daňové účely. Formulace v bloku 7 a FAQ je záměrně opatrná ("za podmínek stanovených zákonem") — konkrétní limity odpočtu a jejich znění pro daný rok si nechat potvrdit od hospodáře, nepsat konkrétní procenta bez ověření.
- **Mobil:** zvážit přeřazení bloku 5 (čísla) před blok 2, aby návštěvník z telefonu dostal konkrétní věc dřív než vyprávění. Jeden sloupec, tlačítka přes celou šířku, žádné vodorovné rolování. Cookie lišta jako úzký pruh nahoře, nikdy jako spodní panel přes CTA.
- **Obrázky:** pouze sborové a architektovy, žádné stock fotografie, z `Resources/Modlitebna Images/`. Komprimovat na načtení do 3 sekund na mobilu. Souhlas s užitím obrázků není doložený — před publikací potvrdit s modlitebna@cb6.cz.
- **Typografie:** tvrdé mezery v číslech a za jednoznakovými předložkami; české uvozovky „takto"; písmo s podmnožinou latin-ext.
